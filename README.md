...
- [Strands SDK announcement](https://aws.amazon.com/blogs/opensource/introducing-strands-agents-an-open-source-ai-agents-sdk/)
...
- [Bedrock evaluations](https://docs.aws.amazon.com/bedrock/latest/userguide/evaluation.html)
  - [Programmatic, based on some standard datasets](https://docs.aws.amazon.com/bedrock/latest/userguide/model-evaluation-tasks.html)
  - [LLM as a judge, with its built-in prompts for different models](https://docs.aws.amazon.com/bedrock/latest/userguide/model-evaluation-type-judge-prompt.html)
  - [Works the same with RAG](https://docs.aws.amazon.com/bedrock/latest/userguide/kb-eval-prompt.html)
  - [Agentcore evaluation prompts](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/prompt-templates-builtin.html)
